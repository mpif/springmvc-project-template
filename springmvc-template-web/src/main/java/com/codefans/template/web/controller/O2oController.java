...
//import com.le.jr.marketing.restapi.service.O2oService;
...
//import com.lejr.marketing.o2o.dto.MarketingLetvoders;
//import com.lejr.marketing.o2o.dto.OwnStoreDto;
...
// * @Desc: O2O相关controller
// */
//@Controller
//@RequestMapping("promotion/o2o")
...
//     */
//    @RequestMapping(method= RequestMethod.POST, value="/clerkCustomerBinding/{version}/{appkey}")
//    @ResponseBody
//    public Message<ClerkCustomerBindingDto> bindClerkCustomer(
...
//            }
//
//            Message<ClerkCustomerBindingDto> message = o2oService.bindClerkCustomer(letvUserId, decodeLeId, decodeLeShopId);
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<StatusResultDto> message = o2oService.addClerk(letvUserId, name, telePhone, noID, leparID);
//            if(message == null || !Result.isSuccess(message.getResult())) {
//                return Messages.failed(message.getCode(), message.getMessage());
//            }
//            return message;
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<IndexCommissionDto> message = o2oService.queryIndexCommissionList(letvUserId);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<FinancialProductResultDto> message = o2oService.queryIndexFinancialProductList(letvUserId);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<ClerkPerformanceResultDto> message = o2oService.queryPersonalPerformanceList(letvUserId, month, pageSize, currentPageNo);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<LeParPerformanceResultDto> message = o2oService.queryTeamPerformanceList(letvUserId, type, month, pageSize, currentPageNo);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<CustomerDetailResultDto> message = o2oService.queryCustomerDetailList(letvUserId, type, pageSize, currentPageNo, assistantID, storeID);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<CustomerDetailDto> message = o2oService.queryCustomerDetail(letvUserId, userID);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<ClerkDetailInfoDto> message = o2oService.queryClerkDetailInfo(letvUserId);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<LeparInfoResultDto> message = o2oService.queryMyStoreList(letvUserId);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<ManagerStoreDto> message = o2oService.queryManagerStore(letvUserId, storeID);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<LeparStaffResultDto> message = o2oService.queryStoreClerkList(letvUserId, leparID, currentPageNo, pageSize);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<RemoveClerkDto> message = o2oService.removeClerk(letvUserId, leparID, userID);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//            Long letvUserId = Long.parseLong(userId);
//
//            Message<ModifyClerkStoreDto> message = o2oService.modifyClerkStore(letvUserId, leparID, userID, aimLeparID);
//            if(message == null || !Result.isSuccess(message.getResult())) {
...
//			}
//			String userId = returnVo.getBean().getResult();
//			Message<List<OwnStoreDto>> result = o2oService.queryOwnStore(Long.valueOf(userId));
//
//			return result;
//		} catch (Exception e) {
...
//			Message<Map<String, Integer>> result = o2oService.moveCustomer(Long.valueOf(letvuserId), storeID, assistantID, userID);
//
//			return result;
//		} catch (Exception e) {
//			LOGGER.info("获取所有客户选择移动到的门店的列表异常.异常信息：{}", e);
...
//			}
//			String userId = returnVo.getBean().getResult();
//			Message<List<OwnStoreDto>> result = o2oService.queryMyStore(Long.valueOf(userId));
//
//			return result;
//		} catch (Exception e) {
...
//				return Messages.failed(CodeEnum.TOKEN_VALIDATE_FAILED.getValue(), "用户token验证失败");
//			}
//			Message<PageVo<MarketingLetvoders>> message = o2oService.getOrderList(pageNo, pageSize, null, null);
//			return message;
//		} catch (Exception e) {
...
//				return Messages.failed(CodeEnum.TOKEN_VALIDATE_FAILED.getValue(), "用户token验证失败");
//			}
//			String message = o2oService.getCallContent(orderId);
//			if(message == null){
...
//				return Messages.failed(CodeEnum.TOKEN_VALIDATE_FAILED.getValue(), "用户token验证失败");
//			}
//			Message<Boolean> message = o2oService.updateCall(orderId);
//
//			return message;
//		} catch (Exception e) {
...
//            String shortUrl = o2oService.generateShortUrl(shortUrlDto);
...
//
//
//    @RequestMapping(value = "/clerkPhoneCheck/{version}/{appkey}/{token}/{phone}", method = RequestMethod.POST)
//    @ResponseBody
//    public Message<Map<String, String>> clerkPhoneCherk(
//            @PathVariable(value = "version") String version,
//            @PathVariable(value = "appkey") String appkey,
//            @PathVariable(value = "token") String token,
//            @PathVariable(value = "phone") String phone) {
//            try {
//                if (!ValidateUtil.isNotEmpty(version,appkey,token, phone)) {
//                    LOGGER.error("参数校验失败version={},appkey={},token={}, phone={}", version, appkey, token, phone);
//                    return Messages.failed(Code.PARAMATERSISNULL.getValue(), "参数校验失败");
//                }
//
//                LOGGER.info("--->clerkPhoneCherk(), phone={}", phone);
//
//                String resultJsonStr = RestClient.getGetRequestResult(RestApiConst.CHECK_TOKEN_VALIDITY, token, String.class);
//                LOGGER.info(resultJsonStr);
//                UserTokenReturnVo returnVo = JsonUtils.readValue(resultJsonStr, UserTokenReturnVo.class);
...
//                Long letvUserId = Long.parseLong(userId);
//
//                Message message = o2oService.clerkPhoneCherk(phone);
//                if(message == null || !Result.isSuccess(message.getResult())) {
//                    return Messages.failed(message.getCode(), message.getMessage());
//                }
//                return message;
//            } catch (Exception e) {
//                LOGGER.info("店员手机号校验异常.异常信息：{}", Throwables.getStackTraceAsString(e));
//                return Messages.failed(Code.SYSTEMEXCEPTION.getValue(), "店员手机号校验异常");
//            }
//        }
//
//
